...
function buildTicketRow(tableBody, ticket) {
    ...
    let tixNumCell = newRow.insertCell()
    let expireCell = newRow.insertCell()
    let prizeCell = newRow.insertCell()
    tixNumCell.innerHTML = ticket.tixNum;
    expireCell.innerHTML = ticket.expires;
    prizeCell.innerHTML = ticket.prize;
    tableBody.appendChild(newRow)
}

function loadWinningTicketsTable () {
    tableBody = document.getElementById('winningTicketsTblBody');
